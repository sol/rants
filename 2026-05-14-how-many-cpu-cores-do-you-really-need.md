...
(Note that for GHC builds we are hitting a hard limit here.  For `cabal`, however, this is highly workload dependent, see my [final remarks](#final-remarks) for why this is.)
