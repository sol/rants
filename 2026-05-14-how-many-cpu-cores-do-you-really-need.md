...
>
> It may very well be that for Haskell development the ***270K*** does not offer any significant advantage over the ***9700X*** (see next section).  This is the whole point I'm trying to make with [`ghc-bench`][ghc-bench]: We should base purchasing decisions on real world performance data, not synthetic benchmarks.
